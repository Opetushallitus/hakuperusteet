...
case class ApplicationObjectWithHakumaksukausi(id: Option[Int], personOid: String, hakukohdeOid: String, hakuOid: String, educationLevel: String, educationCountry: String, hakumaksukausi: Hakumaksukausi)