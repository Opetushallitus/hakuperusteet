...
case class Payment(id: Option[Int], personOid: String, timestamp: Date, reference: String, orderNumber: String, paymCallId: String, status: PaymentStatus, kausi: Hakumaksukausi, hakemusOid: Option[String], history: Option[Seq[PaymentEvent]] = None)
