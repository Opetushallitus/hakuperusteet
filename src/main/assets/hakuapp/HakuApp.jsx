...
import {hasEmailSession, showVetumaStartForHakemus, hasValidPaymentForHakukausi} from '../AppLogic.js'
...
export default class HakuApp extends React.Component {
  render() {
    ...
    return <section id="haku-app">
      ...
      { hasValidPaymentForHakukausi(state) ? <div className="alreadyPaid"><p>{translation("vetuma.result.ok")}</p></div> : null }
    </section>
  }
}