    ...
    return <footer>
      <div>
        <div className="footer-logo">
          <a href={translation("footer.oph.link")} title={translation("footer.oph.title")}><img class="oph-logo" alt={translation("footer.oph.title")} src={"/hakuperusteet/img/OPH_logo-" + lang + ".svg"} /></a>
